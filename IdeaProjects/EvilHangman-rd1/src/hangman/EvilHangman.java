...
public class EvilHangman {
    ...
    private static void playTheGame(EvilHangmanGame game, int guesses, int wordLength) throws GuessAlreadyMadeException {
        ...
        while (guesses > 0)
        {
            ...
            guesses = guessCheck(words, guess, correctGuesses, guesses);//checks for if there are guess or not here
    ...
    private static int guessCheck(Set<String> words, char guess, Map<Integer, Character> correctGuesses, int guesses)
    {
        Iterator it = words.iterator();
